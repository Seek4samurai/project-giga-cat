...
# ⚠️ This game has moved to a new web and server style. This is a self hosted server and is not active at this point.️
...
![Demo-1](https://raw.githubusercontent.com/Seek4samurai/project-giga-cat/main/web/public/demo/Demo-1.png)
![Demo-2](https://raw.githubusercontent.com/Seek4samurai/project-giga-cat/main/web/public/demo/Demo-2.png)

## Check out these Demo clips of the game 🤯

<div style="display: grid; grid-template-columns: 240px 180px">
  <img src="https://github.com/Seek4samurai/project-giga-cat/blob/main/web/public/demo/img_1.gif" width="680" height="480"/>
  <img src="https://github.com/Seek4samurai/project-giga-cat/blob/main/web/public/demo/img_2.gif" width="680" height="480"/>
  <img src="https://github.com/Seek4samurai/project-giga-cat/blob/main/web/public/demo/img_3.gif" width="680" height="480"/>
  <img src="https://github.com/Seek4samurai/project-giga-cat/blob/main/web/public/demo/img_4.gif" width="680" height="480"/>
</div>
...
## ⚠️⚠️⚠️ NOTE : Redis-om code is for the old reference here ⚠️⚠️⚠️

## ⚠️⚠️⚠️ The new database code works over the @upstash/redis ⚠️⚠️⚠️
